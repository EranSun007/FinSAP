...
import { signavioMetrics, signavioCategories } from '../../data/signavioMetricsData';
import styles from '../../styles/pages/Signavio.module.css';

function SignavioSidebar({ visibleMetrics, scale, onScaleChange, onToggleMetric, onToggleCategory }) {
  const [expandedCategories, setExpandedCategories] = useState(
    signavioCategories.reduce((acc, cat) => ({ ...acc, [cat]: true }), {})
  );
  ...
  return (
    <div className={styles.signavioSidebar}>
      <div className={styles.signavioControls}>
        ...
        <div className={styles.accordionContainer}>
          {signavioCategories.map(cat => {
            const catMetrics = signavioMetrics.filter(m => m.category === cat);
